...
updated_data = {
    "vine_spacing": {"value": 1.0, "type": "Float"},
    "under_vine_width": {"value": 0.5, "type": "Float"},
    "anchor_post_distance": {"value": 1.0, "type": "Float"},
}
...
while True:
    ...
    ORION_LIST_ENTITIES_ENDPOINT = (
        f"{ORION_ENDPOINT_BASE}?type=VineRow&limit={limit}&offset={offset}"
    )
    ...
    if response.status_code == 200:
        ...
        for vine_row in vine_rows:
            ...
            update_response = requests.post(
                ORION_ENDPOINT, data=updated_vine_json, headers=headers
            )
            ...
            if update_response.status_code == 204:
                ...
                print(
                    f"Failed to update entity {entity_id}. Status code:",
