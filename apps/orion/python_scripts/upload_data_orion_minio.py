...
destination_file_name = destination_file_name = (
    block_name + "/" + vine_row_name + "/" + vine_name + "/" + file_name
)

FIWARE_ORION_URL = "http://cabbage-xps-8900:1027/v2/entities"
...
def upload_file_to_minio(client, bucket_name, destination_file, source_file):
    ...
    print(
        f"{source_file} successfully uploaded as object {destination_file} to bucket {
            bucket_name
        }"
    )
...
def add_data_to_fiware_orion(bucket_name, destination_file):
    ...
    data = {
        "id": "vine001",
        "type": "Vine",
        "vinerow_id": {"value": "vinerow001", "type": "String"},
        "block_id": {"value": "block001", "type": "String"},
        "vineyard_id": {"value": "vineyard001", "type": "String"},
        "user_defined_id": {"value": "Vine 1", "type": "String"},
        "variety": {"value": "Malbec", "type": "String"},
        "clone": {"value": "Merlot", "type": "String"},
        "rootstock": {"value": "1500C", "type": "String"},
        "location": {
            "type": "geo:json",
            "value": {
                "type": "Point",
        ...
        "grapes_number": {"value": 15, "type": "Integer"},
        "grapes_yield": {"value": 5.8, "type": "Float"},
...
def main():
    try:
        ...
        upload_file_to_minio(
            minio_client, vineyard_name, destination_file_name, file_name
        )
